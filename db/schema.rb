...
ActiveRecord::Schema[7.1].define(version: 2024_04_22_142646) do
  ...
  create_table "trainings", force: :cascade do |t|
    ...
    t.bigint "seedbed_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["seedbed_id"], name: "index_trainings_on_seedbed_id"
  end
  ...
  add_foreign_key "trainings", "seedbeds"
end
