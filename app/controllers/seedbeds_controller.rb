class SeedbedsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @seedbed.save
        format.html { redirect_to seedbed_url(@seedbed), notice: "Seedbed was successfully created." }
  ...
  def update
    respond_to do |format|
      if @seedbed.update(seedbed_params)
        format.html { redirect_to seedbed_url(@seedbed), notice: "Seedbed was successfully updated." }
  ...
  private
    ...
    def seedbed_params
      params.require(:seedbed).permit(:name, :acronym, :research_group, :research_area)
    end
end
